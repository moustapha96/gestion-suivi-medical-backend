...
public class RendezVousController {
	...
	public Map<String, Boolean> ajouterRendezVous(@RequestBody RendezVous pd) {
		RendezVous newPr = repository.save(pd);
		Map<String , Boolean> reponse = new HashMap<>();
		reponse.put("added", true);
		return reponse;
	}
...
//	
	...
	@GetMapping("/RendezVous/patient/{id}")
	public List<RendezVous> getAllrendezVousByPatient(@PathVariable(value = "id") Integer Id) {
		...
		List<RendezVous> rendezVous = new ArrayList<>();
		repository.findAllByPatient(patient).forEach(rendezVous::add);
		return rendezVous;
	}
	
	@GetMapping("/RendezVous/medecin/{id}")
	public List<RendezVous> getAllrendezVousByMedecin(@PathVariable(value = "id") Integer Id) {
		System.out.println("Get all RendezVous...");
		...
		List<RendezVous> rendezVous = new ArrayList<>();
		repository.findAllByMedecin(medecin).forEach(rendezVous::add);
		return rendezVous;
	}
}
